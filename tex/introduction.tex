...
retain cross-compatibility with existing systems \djordje{we don't actually talk about how to implement this selective associativity reduction. And it doesn't sound trivial IMO}.
